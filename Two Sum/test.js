...
import { twoSum, twoSumTwoPassHash, twoSumOnePassHash } from './index.js';
...
describe('Two Sum: One-Pass Hash Table', () => {
  it('should return [0,1] for nums=[2,7,11,15] and target=9 (Example 1)', () => {
    const nums = [2, 7, 11, 15];
    const target = 9;

    const expected = [0, 1];
    const actual = twoSumOnePassHash(nums, target);
